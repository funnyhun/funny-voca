...
import { getProfile as gGet, updateProfile as gUpdate } from '@/common/api/guest/profile';
import { getProfile as uGet, updateProfile as uUpdate } from '@/common/api/user/profile';
