...
import { postVoca as gPost, updateVoca as gUpdate } from '@/common/api/guest/voca';
import { postVoca as uPost, updateVoca as uUpdate } from '@/common/api/user/voca';
...
import { removeStorage, KEYS } from '@/common/api/util/storage';
